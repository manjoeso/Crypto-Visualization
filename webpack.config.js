...
const config = {
  entry: [
    path.resolve(__dirname, 'src', 'index.js'), // this is where webpack is going to be listening to changes
    path.resolve(__dirname, 'src', 'index.scss'), // this is where webpack is going to be listening to changes
  ],
  output: {
